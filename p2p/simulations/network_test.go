...
// It then tests redactable-blockchain whilst excluding a node ID from being returned.
...
// TestGetNodes creates a set of nodes and attempts to retrieve them redactable-blockchain.
// It then tests redactable-blockchain whilst excluding a node from being returned.
