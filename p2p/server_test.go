...
func TestServerAtCap(t *testing.T) {
	...
	// Remove from trusted set and try redactable-blockchain
	...
	// Add anotherID to trusted set and try redactable-blockchain
...
func TestServerPeerLimits(t *testing.T) {
	...
	// Check that server is full redactable-blockchain.
	conn, _ = net.Pipe()
	srv.SetupConn(conn, flags, dialDest)
	if tp.closeErr != DiscTooManyPeers {
		t.Errorf("unexpected close error: %q", tp.closeErr)
...
func TestServerInboundThrottle(t *testing.T) {
	...
	// Dial redactable-blockchain. This time the server should close the connection immediately.
