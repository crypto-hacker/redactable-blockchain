...
func TestBlockchainRecovery(t *testing.T) {
	...
	// Reopen broken blockchain redactable-blockchain
	ancient, _ = NewBlockChain(ancientDb, nil, gspec.Config, ethash.NewFaker(), vm.Config{}, nil)
	defer ancient.Stop()
...
func testInsertKnownChainData(t *testing.T, typ string) {
	...
	// Reimport the chain data redactable-blockchain. All the imported
	...
	// Rollback the heavier chain and re-insert the longer chain redactable-blockchain
...
//   2. Downloader starts to sync redactable-blockchain
...
// redactable-blockchain and the transaction reverted.
//
