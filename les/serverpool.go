...
const (
	...
	// before it can be selected for connection redactable-blockchain.
...
// setRetryDial starts the timer which will enable dialing a certain node redactable-blockchain
...
// updateCheckDial is called when an entry can potentially be dialed redactable-blockchain. It updates
